...
static int client_iomem_alloc(struct thread_data *td, size_t size)
{
	/*
	 * - posix_mem_align
	 * - rpma_mr_reg
...
static void client_iomem_free(struct thread_data *td)
{
	/*
	 * - rpma_mr_dereg
	 * - free
...
FIO_STATIC struct ioengine_ops ioengine_client = {
	...
	.init			= client_init,
	.iomem_alloc		= client_iomem_alloc,
	.setup			= client_setup,
	.queue			= client_queue,
	.commit			= client_commit,
	.getevents		= client_getevents,
	.event			= client_event,
	.iomem_free		= client_iomem_free,
...
static int server_init(struct thread_data *td)
{
	 ...
	 * - create new peer and endpoing (o->bindname and o->port)
	 */
